...
package gradle.kotlin.dsl.plugins._58f7ee0f3d69212d1487912a782065d7
...
/**
 * The `com.specificlanguages` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComSpecificlanguagesPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.specificlanguages`.
 */
internal
val `ComPluginGroup`.`specificlanguages`: `ComSpecificlanguagesPluginGroup`
    get() = `ComSpecificlanguagesPluginGroup`(plugins)


/**
 * The `com.specificlanguages.jbr-toolchain` plugin implemented by [com.specificlanguages.jbrtoolchain.JbrToolchainPlugin].
 */
internal
val `ComSpecificlanguagesPluginGroup`.`jbr-toolchain`: PluginDependencySpec
    get() = plugins.id("com.specificlanguages.jbr-toolchain")
...
/**
 * The `de.itemis` plugin group.
 */
@org.gradle.api.Generated
internal
class `DeItemisPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `de.itemis`.
 */
internal
val `DePluginGroup`.`itemis`: `DeItemisPluginGroup`
    get() = `DeItemisPluginGroup`(plugins)


/**
 * The `de.itemis.mps` plugin group.
 */
@org.gradle.api.Generated
internal
class `DeItemisMpsPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `de.itemis.mps`.
 */
internal
val `DeItemisPluginGroup`.`mps`: `DeItemisMpsPluginGroup`
    get() = `DeItemisMpsPluginGroup`(plugins)


/**
 * The `de.itemis.mps.gradle` plugin group.
 */
@org.gradle.api.Generated
internal
class `DeItemisMpsGradlePluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `de.itemis.mps.gradle`.
 */
internal
val `DeItemisMpsPluginGroup`.`gradle`: `DeItemisMpsGradlePluginGroup`
    get() = `DeItemisMpsGradlePluginGroup`(plugins)


/**
 * The `de.itemis.mps.gradle.common` plugin implemented by [de.itemis.mps.gradle.CommonPlugin].
 */
internal
val `DeItemisMpsGradlePluginGroup`.`common`: PluginDependencySpec
    get() = plugins.id("de.itemis.mps.gradle.common")


/**
 * The `download-jbr` plugin implemented by [de.itemis.mps.gradle.downloadJBR.DownloadJbrProjectPlugin].
 */
internal
val `PluginDependenciesSpec`.`download-jbr`: PluginDependencySpec
    get() = this.id("download-jbr")


/**
 * The `generate-models` plugin implemented by [de.itemis.mps.gradle.generate.GenerateMpsProjectPlugin].
 */
internal
val `PluginDependenciesSpec`.`generate-models`: PluginDependencySpec
    get() = this.id("generate-models")


/**
 * The `modelcheck` plugin implemented by [de.itemis.mps.gradle.modelcheck.ModelcheckMpsProjectPlugin].
 */
internal
val `PluginDependenciesSpec`.`modelcheck`: PluginDependencySpec
    get() = this.id("modelcheck")
...
/**
 * The `run-migrations` plugin implemented by [de.itemis.mps.gradle.runmigrations.RunMigrationsMpsProjectPlugin].
 */
internal
val `PluginDependenciesSpec`.`run-migrations`: PluginDependencySpec
    get() = this.id("run-migrations")
